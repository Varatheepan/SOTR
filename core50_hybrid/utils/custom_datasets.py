...
class MNISTDataset(Dataset):
    def __init__(self, txt=None, transform=None, target_transform=None, loader=default_loader, 
        ...
        self.processed_folder = '../../datasets/MNIST/processed'
        self.class_data = []
        self.class_labels = []
        self.class_count = 10
        if(self.train_test_mode == TRAIN_MODE):
            self.dataset = datasets.MNIST('../../datasets', train=True, download=True,
            ...
            self.dataset = datasets.MNIST('../../datasets', train=False, download=True,
                                        transform=transforms.Compose([
                                            transforms.ToTensor(),
                                            transforms.Normalize((0.1307,), (0.3081,))
                                        ]))

...
if FC_trained:
	for task_id in range(0, 10):
		...
		MultiNet.multi_fcs.update([[str(task_id+1), nn.Linear(256,num_fc_classes)]])
...
if not FC_trained:
	for i in range(1,11):
		...
		MultiNet.multi_fcs.update([[str(i), nn.Linear(256,num_fc_classes)]])
